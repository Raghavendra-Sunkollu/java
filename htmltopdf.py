# import pdfkit
# pdfkit.from_url('https://wkhtmltopdf.org/','shaurya.pdf')
# pdfkit.from_url("https://www.jeremydaly.com/how-to-install-wkhtmltopdf-on-amazon-linux/",'test.pdf')wkhtmltopdf https://wkhtmltopdf.org/ test.pdf
# import subprocess
# url = 'http://www.google.com/'
# output_pdf_file = 'output.pdf'
# cmd = ['wkhtmltopdf', url, output_pdf_file]
# subprocess.run(cmd, check=True)
#cmd = [wkhtmltopdf_path, '--ignore-ssl-errors', url, output_pdf_file]
